...
This document provides instructions for installing PAD-Health on your system.

## Prerequisites

- Linux, Windows, or macOS operating system
- Sensors for temperature and voltage monitoring
- CMake >= 3.10
- C++17 compatible compiler (GCC, Clang, or MSVC)
- Libcurl development libraries (for MQTT support)
...
3. Install libcurl development libraries
